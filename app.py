...
5. Gunakan emoji makanan sesekali agar percakapan lebih menarik 🍽️.
"""
...
# ── Inisialisasi Gemini Client & Chat Session ─────────────────────────────────
...
# ── Pesan Sambutan (hanya jika belum ada riwayat) ────────────────────────────
    ...
    with st.chat_message("assistant"):
        with st.spinner("Chef AI sedang menyiapkan jawaban... 👨‍🍳"):
            try:
                ...
                answer = f"❌ Terjadi kesalahan: {e}. Pastikan API Key kamu benar dan coba lagi."
